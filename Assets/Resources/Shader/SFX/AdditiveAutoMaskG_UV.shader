...
Shader "Custom/SFX/AdditiveAutoMaskG_UV" 
{
    Properties 
	{
    ...
    SubShader 
	{
        ...
        Pass 
		{
            ...
            VertexOutput vert (VertexInput v) 
			{
                ...
                o.uv1 = TRANSFORM_TEX(v.texcoord0,_Mask);
				o.uv1 = lerp(float2(o.uv1.x,o.uv1.y+_Time.y*_Mask_VSpeed), float2(o.uv1.x+_Time.y*_Mask_USpeed, o.uv1.y), 0.5);
            ...
            fixed4 frag(VertexOutput i) : COLOR 
			{
                ...
                fixed4 _Mask_Tex_var = tex2D(_Mask, i.uv1);
                return fixed4(emissive,_Mask_Strength+_Mask_Tex_var.g);
            }
            ENDCG
        }
    }
