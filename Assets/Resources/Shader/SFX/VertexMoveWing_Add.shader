Shader "Custom/SFX/VertexMoveWing_Add"
{
	Properties
	{
		...
		_SwingParameter ("Range,Segment,Speed,Intensity",Vector) = (0.5,1.0,1.0,1)
	}
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				col.rgb = _SwingParameter.w * lerp(col.rgb * col.a, _FlowColor.rgb * _FlowParameter.x * col.rgb * col.a, mask.r * _FlowColor.a) * alpha * i.color.rgb * i.color.a;
				return col;
			}
			ENDCG
		}
