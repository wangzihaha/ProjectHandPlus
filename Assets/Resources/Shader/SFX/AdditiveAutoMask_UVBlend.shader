...
Shader "Custom/SFX/AdditiveAutoMask_UVBlend" 
{
    Properties 
	{
    ...
    SubShader 
	{
        ...
        Pass 
		{
            ...
            VertexOutput vert (VertexInput v) 
			{
                ...
                o.uv1 = TRANSFORM_TEX(v.texcoord0,_Mask_Tex);
				o.uv1 = lerp(fixed2(o.uv1.x,o.uv1.y+_Time.y*_Mask_VSpeed), fixed2(o.uv1.x+_Time.y*_Mask_USpeed, o.uv1.y), 0.5);
            ...
            fixed4 frag(VertexOutput i) : COLOR 
			{
				...
				fixed3 emissive = _Texture_var.rgb*i.vertexColor.rgb*_Strength*_Texture_var.a + _Alpha_attenuation;
                fixed4 _Mask_Tex_var = tex2D(_Mask_Tex, i.uv1);
                return fixed4(emissive,(_Mask_Strength+_Mask_Tex_var.r) * i.vertexColor.a * _Texture_var.a);
            }
            ENDCG
        }
    }
