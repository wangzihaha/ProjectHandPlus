Shader "Custom/SFX/DestortionTexture_Blend2"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				v2f o;
				half3 viewPosition = mul(UNITY_MATRIX_MV, v.vertex);

				o.vertex = UnityObjectToClipPos(v.vertex * -viewPosition.z* _Scale);
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed4 col = tex2D(_MainTex, i.uv + _DisInt * distortion.xy) * _Color * i.color;
				return col;
			}
			ENDCG
		}
